<?php $__env->startSection('title', 'Jasa IT Terpercaya | Software House & IT Consultant - Sekawan Putra Pratama'); ?>
<?php $__env->startSection('meta_description', 'Software house terpercaya sejak 2015. Jasa pembuatan website profesional, aplikasi mobile Android/iOS, instalasi server & jaringan kantor. Konsultasi GRATIS! Hubungi kami sekarang.'); ?>
<?php $__env->startSection('meta_keywords', 'jasa IT terpercaya, software house Indonesia, jasa pembuatan website, aplikasi mobile, instalasi server, IT consultant Jakarta, web developer profesional'); ?>

<?php $__env->startSection('og_title', 'Sekawan Putra Pratama - Solusi IT Terintegrasi & Terpercaya'); ?>
<?php $__env->startSection('og_description', 'Software house & IT consultant terpercaya sejak 2015. Website, Aplikasi Mobile, Server & Jaringan. Konsultasi GRATIS!'); ?>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-center justify-content-lg-start animate-up" style="animation-delay: 0.4s;">
                    <a href="<?php echo e(route('services.index')); ?>" class="btn-modern-primary">
                        Jelajahi Solusi <i class="fas fa-arrow-right ms-2"></i>
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="btn-modern-outline">
                        Konsultasi Gratis
                    </a>
                </div>
            ...
            <div class="col-lg-5 d-none d-lg-block animate-up" style="animation-delay: 0.6s;">
                <div class="hero-visual-container">
                    <div class="image-glass-frame">
                        <img src="<?php echo e(asset('assets/media/images/about-cover.png')); ?>" class="img-fluid rounded-4 main-img" alt="Sekawan Tech">
                    </div>
        ...
        <div class="row align-items-center g-5 mb-100 animate-up">
            <div class="col-lg-6">
                <div class="service-image-container position-relative">
                    ...
                    <img src="<?php echo e(asset('assets/media/images/app-development.png')); ?>" alt="App Development" class="img-fluid rounded-4 shadow-lg position-relative z-2">
            ...
            <div class="col-lg-6 ps-lg-5">
                <div class="service-content">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="btn btn-primary rounded-pill px-5 py-3 fw-bold">Jelajahi Detail <i class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center g-5 mb-100 animate-up">
            <div class="col-lg-6 order-lg-2">
                <div class="service-image-container position-relative">
                    ...
                    <img src="<?php echo e(asset('assets/media/images/web-development.png')); ?>" alt="Web Development" class="img-fluid rounded-4 shadow-lg position-relative z-2">
        ...
        <div class="row align-items-center g-5 animate-up">
            <div class="col-lg-6">
                <div class="service-image-container position-relative">
                    ...
                    <img src="<?php echo e(asset('assets/media/images/office-server.png')); ?>" alt="Office Server" class="img-fluid rounded-4 shadow-lg position-relative z-2">
    ...
    <div class="container py-lg-5">
        <div class="row align-items-end mb-5">
            ...
            <div class="col-md-4 text-center text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('portfolio.index')); ?>" class="btn btn-outline-primary rounded-pill px-4">Lihat Semua Proyek</a>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="portfolio-item position-relative overflow-hidden rounded-4 shadow-sm">
                    <img src="<?php echo e(asset('assets/media/images/tab-image-1.png')); ?>" class="img-fluid w-100 transition-all" alt="Web Project">
            ...
            <div class="col-md-6">
                <div class="portfolio-item position-relative overflow-hidden rounded-4 shadow-sm">
                    <img src="<?php echo e(asset('assets/media/images/tab-image-2.png')); ?>" class="img-fluid w-100 transition-all" alt="App Project">
                    <div class="overlay p-4 d-flex flex-column justify-content-end">
...
<section class="py-5" style="background: linear-gradient(135deg, #0d6efd 0%, #0b5ed7 100%);">
    <div class="container py-4 text-center">
        ...
        <div class="d-flex justify-content-center gap-3">
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-light btn-lg rounded-pill px-5 fw-bold text-primary">Mulai Konsultasi</a>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SPP\resources\views/frontend/home.blade.php ENDPATH**/ ?>