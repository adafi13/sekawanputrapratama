...
<section class="py-5 bg-white">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-7">
                <div class="mb-4">
                    <span class="badge bg-primary bg-opacity-10 text-primary fw-bold px-3 py-2 me-2 mb-2">{{ $job['department'] }}</span>
                    <span class="badge bg-light text-dark border px-3 py-2 mb-2">{{ $job['type'] }}</span>
            ...
            {{-- APPLICATION FORM --}}
            <div class="col-lg-5">
                <div class="bg-light p-4 rounded-4 border shadow-sm sticky-top" style="top: 100px;">
                    ...
                    <form action="{{ route('careers.apply', $job['slug']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="cover_letter" id="cover_letter" class="form-control" rows="3" placeholder="Ceritakan singkat pengalamaan dan alasan Anda melamar posisi ini..."></textarea>
                        </div>
