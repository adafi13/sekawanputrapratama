...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold">All Team Members</h3>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($members as $member)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">{{ $member->position }}</td>
                        <td class="px-6 py-4">
                            @if($member->is_active)
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <a href="{{ route('admin.team.edit', $member) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
